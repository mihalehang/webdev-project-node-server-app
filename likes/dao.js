...
export const createUserLikesMovie = (userId, userName, movieId, movieTitle, poster) => model.create({ user: userId, userName: userName, movieId: movieId, movieTitle: movieTitle, poster: poster});
...
export const findUsersRecentLike = (userId) => model.find({ user: userId}).sort({_id: -1}).limit(3);