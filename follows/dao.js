...
export const findUsersFollowedByUser = (userId) => model.find({ follower: userId }).populate('followed').exec();

export const findUsersFollowingUser = (userId) => model.find({ followed: userId }).populate('follower').exec();
